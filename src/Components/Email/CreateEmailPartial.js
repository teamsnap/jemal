    ...
    constructor(props) {
      ...
      createEmailPartial() {
          ...
          this.props
              ...
              .then(data => {
                  this.props.history.push(`/email/partials/edit/${data.data.createEmailPartial._id}`)
              })
              .catch(error => {
                  console.error(error);
                  this.setState({
        ...
        return (
            <div>
              <Card style={styles.card}>
                  <CardContent>
                      <form action="/">
                      <Typography variant="headline" component="h1">Create a new email template partial</Typography>
                  ...
                  <CardActions>
                    <Button variant="raised" color="primary" size="small" onClick={this.createEmailPartial}>Create</Button>
...
const createEmailPartial = gql`
  mutation createEmailPartial($title: String!, $mjmlSource: String, $filePath: String $organizationId: String!) {
      createEmailPartial(title: $title, mjmlSource: $mjmlSource, filePath: $filePath, organizationId: $organizationId) {
          _id
      }
  }
`;
