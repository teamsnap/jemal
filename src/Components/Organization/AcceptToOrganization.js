...
class AcceptToOrganizationView extends Component {
    ...
    acceptToOrganization() {
        ...
        this.props
            ...
            .then(() => this.setState({ success: 'Great! You are now apart of the organization now!' }))
    ...
    render() {
        ...
        console.log(this.props.getOrganization.currentOrganization && this.props.getOrganization.currentOrganization.logoUrl)
                ...
                <Card style={styles.card}>
                    <CardContent>
                        <form action="/">
                            ...
                            <img src={this.props.getOrganization.currentOrganization && this.props.getOrganization.currentOrganization.logoUrl} alt={this.props.getOrganization.currentOrganization && this.props.getOrganization.currentOrganization.name} />
                            <Typography variant="headline" component="h1">You have been Invited to {this.props.getOrganization.currentOrganization && this.props.getOrganization.currentOrganization.name}</Typography>
                    ...
                    <CardActions>
                        <Button variant="raised" color="primary" size="small" onClick={this.acceptToOrganization}>Invite</Button>
