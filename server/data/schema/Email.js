...
const Email = gql`
  ...
  extend type Mutation {
    createEmail(title: String!, mjmlSource: String, baseTemplate: Boolean, duplicatedFrom: String, folderPath: String, favorited: Boolean, isApproved: Boolean, hasBeenSent: Boolean, isDraft: Boolean, organizationId: String! baseTemplate: Boolean): Email
    editEmail(_id: String!, title: String!, baseTemplate: Boolean, updatedAt: String, mjmlSource: String!, folderPath: String, favorited: Boolean, isApproved: Boolean, hasBeenSent: Boolean, isDraft: Boolean, organizationId: String): Email
